...
window.iconphoto(False, logo_icon)
window.after(250, lambda:window.iconphoto(False, logo_icon))
...
def generate_invoice():
    doc = DocxTemplate(os.path.join(os.path.dirname(__file__),"invoice_template.docx"))
    if not os.path.exists(
            os.path.join(os.path.dirname(__file__),"invoice_template.docx")):
